...
async def test_ssscu_multiproduct_and_js_errors(
    ...
    expected_h2_headings = [
        ...
        "INTRODUCTORY 0% APR* ON EVERY PURCHASE1 AND BALANCE TRANSFER1",  # Replace with actual expected heading for card 1 or another possible heading if expected card 1 times out
        "DEBT CONSOLIDATION"
    ]
    ...
    expected_card_ads_CTA_links = [
        ...
        "https://app.loanspq.com/cc/CreditCard.aspx?lenderref=ssscu111517&type=1", # Replace with actual expected CTA link for card or another possible CTA link if expected card 1 times out
        "https://app.loanspq.com/apply.aspx?lenderref=ssscu111517&list=ccplvlheST"
    ]

...
class PreviewContent:
    ...
    def __init__(self, page):
        ...
        # Automatically detect the first "Test Core Products" campaign (no monthly updates needed)
        self.test_core_products_link = page.get_by_text("Test Core Products", exact=False).first
...
def test_content_preview_segment(admin_browser_context_sync):
    ...
    screenshots_directory = os.path.join(os.path.dirname(__file__), 'screenshots_adminsite_using_pytest/content_preview_segment/')

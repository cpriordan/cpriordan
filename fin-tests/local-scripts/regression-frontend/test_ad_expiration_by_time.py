...
async def test_check_ad_expiration_by_time(
    ...
    dynamic_expected_heading1 = f"Car Loan Ad {expected_heading1_number} that expires 30 seconds after session starts"
    ...
    dynamic_expected_heading2 = f"Car Loan Ad {expected_heading2_number} that expires 30 seconds after session starts"

...
@pytest.mark.parametrize(
    "browser",
    [{"username": "cscustg", "password": "6e2a5a2c"}],
    indirect=True,
)
async def test_cscu_savings_stgtags_and_js_errors(
    browser,
    homepage_url="https://cscustg.wpengine.com/?api=stg",
    test_scenario_url="https://cscustg.wpengine.com/savings-account/",
    expected_heading="SAVINGS ACCOUNTS",
    hero_heading_selector="div.hero_message>h1",
    client="cscu",

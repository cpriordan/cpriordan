...
async def test_oneaz_stgtags_and_js_errors(
    ...
    test_scenario_url="https://oneazcuqa.oneazcu.com/?api=stg",
    expected_heading="YOUR BUSINESS SUCCESS STORY STARTS HERE.",
    hero_heading_selector="#finalytics > li > div > div > div > h1",
    client="oneaz",
    ...
    try:
        ...
        await page.screenshot(path=f'{screenshots_directory}/hero_ad1_screenshot_on_{browser_type}.png', full_page=True)

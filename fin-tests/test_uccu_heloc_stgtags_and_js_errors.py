...
async def test_uccu_heloc_stgtags_and_js_errors(
    browser,
    homepage_url="http://staging.uccu.com/?api=stg",
    test_scenario_url="https://staging.uccu.com/loans/personal/heloc/",
    expected_heading="PUT YOUR HOME'S EQUITY TO WORK",
    hero_heading_selector="h1.has-white-color.has-text-color",
    client="uccu",

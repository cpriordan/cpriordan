...
async def browser(request):
    ...
    username = os.getenv("BASIC_AUTH_USER") or param_user or "MissionFed"
    password = os.getenv("BASIC_AUTH_PASS") or param_pass or "MissionFed"
...
async def test_missionfed_hero_ocr_ci(
    browser,
    homepage_url="https://stage.missionfed.com/?cb=1&api=stg",
    ...
    baseline_github_tree_dir: str = "https://github.com/carina-finai/tests/tree/tests/fin-tests/QA/missionfed/baseline",
    ...
    try:
        baseline_hero_path = resolve_baseline_image(
            ...
            test_dir=test_dir,
            baseline_rel_dir="missionfed/baseline",

...
async def test_oneaz_hero_ocr_ci(
    ...
    test_scenario_url="https://oneazcuqa.oneazcu.com/business",
    ...
    baseline_github_tree_dir: str = "https://github.com/carina-finai/tests/tree/tests/fin-tests/QA/oneaz/baseline",
    ...
    try:
        baseline_hero_path = resolve_baseline_image(
            ...
            test_dir=test_dir,
            baseline_rel_dir="oneaz/baseline",

...
@pytest.mark.asyncio
async def test_lfcu_checking_stgtags_and_js_errors(
    browser,
    ...
    # specific_js_files = ['finalytics.js', 'finalytics-function.js', 'settings_div.js', 'settings.js', 'controlbar.js', 'cxbus.min.js']
    # Include cxbus.min.js in the specific_js_files  to force a JS error on api=stg

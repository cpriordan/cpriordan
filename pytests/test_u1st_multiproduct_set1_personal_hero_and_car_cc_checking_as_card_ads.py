...
@pytest.mark.parametrize("product_urls", [
    {
        ...
        "personal_loan": "https://1stunitedcu.cms.banno-staging.com/loans-and-credit/product/personal-loans-and-lines?api=stg&segments=holiday savings 2026",
...
async def test_u1st_multiproducts_and_js_errors(
        ...
        personal_loan_expected_heading="Your Holiday Loan Is Here",
        mortgage_loan_expected_heading="Ready for a Better Rate—or a New Home?",
    ...
    expected_h2_headings = [
        "Ready, Set, Drive",
        "Lower Your Credit Card Interest \u2014 As Low as 3.90% APR",

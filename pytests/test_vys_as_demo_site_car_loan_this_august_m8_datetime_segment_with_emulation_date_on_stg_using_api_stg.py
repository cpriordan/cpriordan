...
async def test_vys_auto_loan_personalization_off(
    browser,
    homepage_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_aug?api=stg&cb=1&debug_all=1",
    test_scenario_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_aug?cb=1&debug_all=1&api=stg&segments=m8&emulation_date=2025-08-03",
    expected_heading="Own a Convertible Car this August",

...
data = [
    "https://www.stgfinalyticsdemo.com/qa/datetime_segments_aug?cb=1&debug_all=1&api=stg&segments=m8&emulation_date=2025-08-03",
    {
        'url': "https://www.stgfinalyticsdemo.com/qa/datetime_segments_aug?api=stg&cb=1&debug_all=1",
        'expected': {
            'h1': "Own a Convertible Car this August",

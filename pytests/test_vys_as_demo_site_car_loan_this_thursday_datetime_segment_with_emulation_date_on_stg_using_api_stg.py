...
async def test_vys_auto_loan_personalization_off(
    browser,
    homepage_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_thu?api=stg&cb=1&debug_all=1",
    test_scenario_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_thu?cb=1&debug_all=1&api=stg&segments=thu&emulation_date=2025-08-01",
    expected_heading="Own a Convertible Car this Thursday",
    hero_heading_selector="body > main > div.layout.c-hero.light > div > div > div > h1", #div.col-12 h1::first-line
    ...
    print(f"Cleared screenshots directory to update screenshots in {screenshots_directory}...")
    ...
    try:
        ...
        print(f"Returning to homepage_url {homepage_url} to check that the ad is displayed since datetime seg is enabled on VYS")
        await page.goto(homepage_url, timeout=DEFAULT_TIMEOUT)

...
async def test_marketusafcu_auto_loan_personalization_off(
    browser,
    homepage_url="https://www.stgfinalyticsdemo.com/demo/marketusafcu?api=stg&cb=1&debug_all=1",
    test_scenario_url="https://www.stgfinalyticsdemo.com/personal/borrow/auto-and-recreational-loans/auto-loans",
    expected_heading="Banking with the Best",
    hero_heading_selector="#test > div > div > div > div > h1",  # body > main > div.layout.c-hero.light > div > div > div > h1 PERSONALIZATION ON
    hero_class_selector="#test > div", # body > main > div.layout.c-hero.light PERSONALIZATION ON
    client="marketusafcu_personalization_off_intercept_settings_div_personalization_off",
    ...
    async def intercept_settings_div_js(route, request):
        target_url = "https://d1v4vw9mwf7wyh.cloudfront.net/v3/marketusafcu/settings_div.js"
        redirect_url = "https://d1v4vw9mwf7wyh.cloudfront.net/v3/marketusafcu/personalization_disabled/settings_div.js"
    ...
    try:
        ...
        # await page.wait_for_selector(hero_class_selector, timeout=DEFAULT_TIMEOUT)
        ...
        try:
            ...
            await save_page_source_async(page, os.path.join(screenshots_directory, "page_source_timeout.html"))

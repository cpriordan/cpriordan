...
def test_check_basic_admin_account_access(admin_browser_context_sync):
    """Refactored admin test using consolidated qa_tools functions."""
    ...
    login_page.take_screenshot(f'{screenshots_dir}1_successful_login_using_2fa.png')
    ...
    # Final screenshot
    page.screenshot(path=f'{screenshots_dir}2_basic_admin_account_accessible_links.png')
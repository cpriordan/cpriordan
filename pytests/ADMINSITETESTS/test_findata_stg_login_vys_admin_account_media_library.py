...
async def test_media_library_addition_and_deletion_of_images():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # File path for image upload -- committed as a test fixture so it's available in CI
            local_image_to_upload = os.path.join(os.path.dirname(__file__), "test_assets", "car_image.jpg")
            screenshots_directory = os.path.join(os.path.dirname(__file__), 'screenshots_adminsite_using_pytest/media_library/')

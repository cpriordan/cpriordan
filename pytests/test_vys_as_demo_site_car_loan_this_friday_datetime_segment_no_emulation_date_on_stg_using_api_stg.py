...
async def test_vys_auto_loan_personalization_off(
    browser,
    homepage_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_fri_no_emulation_date?cb=1&debug_all=1&api=stg",
    test_scenario_url="https://www.stgfinalyticsdemo.com/qa/datetime_segments_fri_no_emulation_date?cb=1&debug_all=1&api=stg&segments=fri",
    expected_heading="Own a Convertible Car this Friday",
    ...
    client="vys_demo_site_fri_no_emulation_date",
    ...
    print(f"Cleared screenshots directory to update screenshots{screenshots_directory}...")

...
data = [
    "https://www.stgfinalyticsdemo.com/qa/datetime_segments_fri_no_emulation_date?cb=1&debug_all=1&api=stg&segments=fri",
    {
        'url': "https://www.stgfinalyticsdemo.com/qa/datetime_segments_fri_no_emulation_date?cb=1&debug_all=1&api=stg",
        'expected': {
            'h1': "Own a Convertible Car this Friday",
